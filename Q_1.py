...
def cost2IndexConstructor(segment, root, r):
    ...
    #print("costlist2indes :",costList2index)
...
def cost(root, segment, r):
    ...
    #print(np.outer(costList1index, costList1index))
...
def QConstructor(root, make_csv=False, r=3):
    ...
    print('costSum :',costSum(noOfSegs, root, r))
    print('constraints :',constraints(root, lembda(noOfSegs, root, r), r))
